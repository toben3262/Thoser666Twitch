...
- Thoser666Twitch-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- Thoser666Twitch-ui: main application module, development time
- Thoser666Twitch-production: module that produces a production mode WAR for deployment
